...
MODEL                := realtime
MODULES              := realtime_data.c realtime_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := realtime.mk
...
#
MODELLIB                  := realtimelib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := realtime_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/Users/aluno/Desktop/CARLAE~1;$(MATLAB_ROOT)/simulink/include/sf_runtime;C:/Users/aluno/Desktop/CARLAE~1/realtime_sldrt_win64;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
